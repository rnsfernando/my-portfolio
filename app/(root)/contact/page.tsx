            ...
            <div className="relative p-8 md:p-10 rounded-3xl bg-card/90 backdrop-blur-xl border border-border/50 shadow-2xl">
              <div className="space-y-8">
                ...
                <a href="tel:+94740697048" className="flex items-center gap-5 p-4 rounded-2xl hover:bg-primary/5 border border-transparent hover:border-primary/10 transition-all duration-300 group/item cursor-pointer">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-muted-foreground mb-0.5 uppercase tracking-wide">Phone</p>
                    <p className="text-xl font-bold tracking-tight text-foreground">+94 740 697 048</p>
                  </div>
                </a>
                ...
                <div className="flex items-start gap-5 p-4 rounded-2xl hover:bg-primary/5 border border-transparent hover:border-primary/10 transition-all duration-300 group/item">
                  ...
                  <div className="flex-1 space-y-1.5">
                    <p className="text-sm font-semibold text-muted-foreground mb-0.5 uppercase tracking-wide">Email</p>
                    <a href="mailto:rnsithmafernando02@gmail.com" className="block text-lg font-medium hover:text-primary transition-colors">rnsithmafernando02@gmail.com</a>
                    <a href="mailto:fernandowwrns.21@uom.lk" className="block text-lg font-medium hover:text-primary transition-colors">fernandowwrns.21@uom.lk</a>
                  </div>
                </div>
